...
--
-- Dumping data for table `inventory_lamppost_asc`
--

INSERT INTO `inventory_lamppost_asc` (`Item_id`, `lamppost_id`, `quantity`) VALUES
(1, 1234, 1),
(2, 1234, 1),
(3, 1234, 3),
(4, 1234, 1),
...
(1000, 'baddegama', 6.887286, 79.86136, '0000-00-00'),
(1001, 'Gonaduwa, x Rd ', 6.890779, 79.858037, '0000-00-00'),
(1002, 'Milagiriya', 6.891551, 79.85477, '0000-00-00'),
...
(1234, 'Hospital Bus Stop, Waskaduwa - Bandaragama Rd, Maha Gonaduwa, Sri Lanka', 6.6709491532289045, 79.97143849211528, '0000-00-00');
