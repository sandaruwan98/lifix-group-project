		...
		<div class="contact-box">
			...
			<div class="right">
				...
				<form action="index.php" method="POST">
					...
					<input type="text" name="nic" value="<?php echo htmlspecialchars($nic) ?>" class="field" placeholder="<?php if($errors['nic']) echo 'හැඳුනුම්පත් අංකය අත්‍යාවශ්‍ය වේ'; else echo 'හැඳුනුම්පත් අංකය'; ?>" >				
